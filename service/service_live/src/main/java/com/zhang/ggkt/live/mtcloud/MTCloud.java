...
package com.zhang.ggkt.live.mtcloud;


import com.zhang.ggkt.live.mtcloud.utils.MD5Util;
...
public class MTCloud {
     ...
     * 合作方ID： 合作方在欢拓平台的唯一ID
     */
    public String openID = "58099";

    /**
     * 合作方秘钥： 合作方ID对应的参数加密秘钥
     */
    public String openToken = "4e9dcb8088fbaa2d5359f1f07df5fc38";
