...
import com.zhang.ggkt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long orderId) {
        String openid = "oa6vA6jvU1pFKnqb1bJqXINoSQgw";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("7V8FHoL8Q67lBIvxkSpnIF0Z4rrzM5EKyQ4Ouww45MI")//模板id
                .url("https://7b38u30724.goho.co/#/pay/"+orderId)//点击模板消息要访问的网址
                .build();
